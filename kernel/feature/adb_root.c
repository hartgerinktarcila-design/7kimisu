...
{
    static const char kLibAdbRoot[] = "/data/adb/sevenk/lib/libadbroot.so";
    struct path path;
...
{
    static const char kLdPreload[] = "LD_PRELOAD=/data/adb/sevenk/lib/libadbroot.so";
    static const char kLdLibraryPath[] = "LD_LIBRARY_PATH=/data/adb/sevenk/lib";
