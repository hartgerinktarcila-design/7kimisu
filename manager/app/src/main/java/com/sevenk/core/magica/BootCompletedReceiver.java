package com.sevenk.core.magica;

import static com.sevenk.core.magica.AppZygotePreload.TAG;
...
import com.sevenk.core.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.sevenk.core.magica.LAUNCH".equals(action)) {
            return;
        }
